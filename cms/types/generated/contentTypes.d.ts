...
export interface ApiAnimationAnimation extends Schema.CollectionType {
  ...
  attributes: {
    ...
    Javascript_Code: Attribute.JSON & Attribute.Required;
    Webflow_Code: Attribute.JSON & Attribute.Required;
    Animation_Duration: Attribute.Decimal;
    Animation_Delay: Attribute.Decimal;
    Animation_Stagger: Attribute.Float;
    Animation_Ease: Attribute.String;
